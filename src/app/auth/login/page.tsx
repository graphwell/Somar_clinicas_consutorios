...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans flex flex-col">
      ...
      {/* White Footer */}
      <footer className="bg-white border-t border-gray-100 py-8 px-8 flex flex-col sm:flex-row items-center justify-between gap-6 text-xs text-gray-400 font-medium">
        <div />
