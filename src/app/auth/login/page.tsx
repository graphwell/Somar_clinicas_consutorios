...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans flex flex-col">
      ...
      {/* White Header */}
      <header className="bg-white border-b border-gray-100 h-16 flex items-center px-8">
        <Link href="/">
          <img src="/synka-logo.png" alt="Synka" className="h-9 object-contain" />
        </Link>
      </header>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-white border border-gray-200 rounded-3xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            <img src="/synka-logo.png" alt="Synka" className="h-12 object-contain mx-auto mb-5" />
      ...
      {/* White Footer */}
      <footer className="bg-white border-t border-gray-100 py-4 px-8 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-400">
        <img src="/synka-logo.png" alt="Synka" className="h-6 object-contain" />
