...
const DORES = [
  { dor: '"Paciente não apareceu à sessão e nem avisou."', fix: "Synka confirma presença 24h antes. Sessão garantida." },
  { dor: '"Fico trocando mensagens para reagendar e remarcar."', fix: "IA resolve tudo. Você foca no acolhimento." },
  { dor: '"Paciente some depois de 3 sessões e nunca mais retorna."', fix: "Lembrete automático de retorno. Fidelização no piloto." },
  { dor: '"Atendo online e presencial e a agenda fica uma bagunça."', fix: "Agenda unificada em tempo real. Tudo num painel só." },
  { dor: '"Perco tempo precioso com burocracia de agendamento."', fix: "Synka cuida da agenda. Você cuida da saúde mental." },
];

const SERVICOS = [
  { emoji: "🧠", nome: "Consulta Individual", preco: "R$ 150 – 350/sessão", desc: "Exiba sua abordagem e diferencial. Paciente chega preparado.", destaque: false },
  { emoji: "👥", nome: "Terapia de Casal", preco: "R$ 200 – 400/sessão", desc: "Alto ticket. Clientes chegam conhecendo o valor antes da primeira sessão.", destaque: true },
  { emoji: "💻", nome: "Psicoterapia Online", preco: "R$ 130 – 280/sessão", desc: "Agenda online ou unificada. Paciente agenda sem precisar ligar.", destaque: false },
  { emoji: "🧒", nome: "Psicologia Infantil", preco: "R$ 160 – 320/sessão", desc: "Inclua orientação para pais. Diferencial que poucos oferecem.", destaque: false },
  { emoji: "🔄", nome: "Pacote de Sessões", preco: "R$ 500 – 1.200", desc: "Venda 5 ou 10 sessões com desconto. Receita previsível e fidelização.", destaque: false },
  { emoji: "📋", nome: "Avaliação Psicológica", preco: "R$ 800 – 2.000", desc: "Alto valor. Apresente detalhes e inclua no processo de agendamento.", destaque: false },
];

const DEPOIMENTOS = [
  { nome: "Dra. Isabela Freitas", negocio: "Psicóloga Clínica – Fortaleza/CE", avatar: "IF", texto: "Eu tinha uma média de 4 faltas por semana. Com o Synka caiu para quase zero. Só esse ganho paga o sistema 10x por mês.", estrelas: 5 },
  { nome: "Dr. Lucas Carvalho", negocio: "Psicólogo – São Paulo/SP", avatar: "LC", texto: "Atendo online e presencial. Antes a agenda era um caos. Agora tudo acontece automático e eu foco 100% nos pacientes.", estrelas: 5 },
    ...
    <div className="min-h-[100svh] bg-[#050510] text-white font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-[100svh] flex flex-col items-center justify-center text-center px-6 pt-36 pb-20 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-2/3 left-1/4 w-[400px] h-[300px] bg-[#6366F1]/5 rounded-full blur-[90px]" />
        </div>
        <div className="inline-flex items-center gap-2 bg-[#40916C]/10 border border-[#40916C]/25 rounded-full px-4 py-1.5 text-xs text-[#95D5B2] font-semibold uppercase tracking-widest mb-8">
          <span className="w-1.5 h-1.5 rounded-full bg-[#40916C] animate-pulse" />Para Psicólogos e Terapeutas
        </div>
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold leading-tight max-w-5xl mb-6 tracking-tight">
          Você cuida da mente dos outros.<br/>
          <span className="bg-gradient-to-r from-[#52B788] to-[#95D5B2] bg-clip-text text-transparent">Quem cuida da sua agenda?</span>
        </h1>
        <p className="text-gray-400 text-xl max-w-2xl mb-4 leading-relaxed">
          Faltas, remarcações, pacientes que somem — isso custa caro e consome energia que deveria ir para seus pacientes.
          <br/><span className="text-[#52B788] font-semibold">O Synka cuida da agenda por você — automático, 24h, sem esforço.</span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-20 w-full sm:w-auto items-center">
          <Link href={CTA} id="hero-cta-psicologia" className="w-full sm:w-auto max-w-xs px-8 py-4 bg-[#40916C] hover:bg-[#2D6A4F] rounded-2xl text-base font-bold transition-all shadow-[0_8px_32px_rgba(64,145,108,0.45)] hover:-translate-y-0.5 text-center">Testar grátis — 30 dias →</Link>
          <a href={WA} target="_blank" rel="noopener noreferrer" id="hero-wa-psicologia" className="w-full sm:w-auto max-w-xs px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/15 rounded-2xl text-base font-semibold transition-all text-center flex items-center justify-center gap-2">
        ...
        <div className="flex flex-wrap justify-center gap-8 sm:gap-16 text-center">
          {[{val:"70%",label:"menos faltas e no-shows"},{val:"24h",label:"agenda funcionando sozinha"},{val:"100%",label:"foco nos seus pacientes"}].map(s=>(
      ...
      <section className="py-20 px-6 bg-[#08081a]">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-gradient-to-br from-[#1B4332]/50 to-[#0a1a14]/80 border border-[#40916C]/20 rounded-3xl px-8 sm:px-14 py-14">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold leading-tight mb-6">É o <span className="bg-gradient-to-r from-[#52B788] to-[#95D5B2] bg-clip-text text-transparent">tempo e dinheiro perdido</span> com burocracia de agenda.</h2>
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Um psicólogo com 4 faltas por semana no valor médio de R$ 200 perde{" "}
              <strong className="text-red-400">R$ 3.200 por mês</strong>.{" "}
              <span className="text-[#52B788] font-semibold">O Synka paga o próprio investimento com 1 falta evitada.</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section ref={ref} className="py-20 px-6 bg-[#08081a]">
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          {[{value:counts[0],suffix:"%",label:"de redução em faltas",color:"from-green-400 to-emerald-300"},{value:counts[1],suffix:"h",label:"agenda funcionando sozinha por dia",color:"from-[#52B788] to-[#40916C]"},{value:counts[2],suffix:"%",label:"de pacientes retornam com lembrete automático",color:"from-[#95D5B2] to-[#52B788]"}].map((s,i)=>(
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-[#08081a] to-[#050510]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-6">
            ...
            <h2 className="text-3xl sm:text-5xl font-bold mb-4">Sua vitrine de serviços <span className="bg-gradient-to-r from-[#52B788] to-[#95D5B2] bg-clip-text text-transparent">dentro do agendamento</span></h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">O paciente vê <strong className="text-white">suas especialidades, abordagem e valores</strong> antes de agendar. Ele chega preparado e comprometido.</p>
          </div>
      ...
      <section className="py-24 px-6 bg-[#08081a]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14"><p className="text-xs uppercase tracking-widest text-[#52B788] font-bold mb-3">Psicólogos falam</p><h2 className="text-3xl sm:text-4xl font-bold">Resultado real, no consultório de quem usou</h2></div>
      ...
      <section className="py-28 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <h2 className="text-4xl sm:text-6xl font-extrabold mb-6 leading-tight">Pare de perder sessão.<br/><span className="bg-gradient-to-r from-[#52B788] to-[#2D6A4F] bg-clip-text text-transparent">Comece grátis hoje.</span></h2>
          <p className="text-gray-400 mb-4 text-lg">30 dias gratuitos. Sem cartão. Sem burocracia.</p>
          <p className="text-gray-500 text-sm mb-10">Em menos de 24h seu consultório já terá agendamento automático funcionando.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={CTA} id="cta-final-psicologia" className="px-10 py-5 bg-[#40916C] hover:bg-[#2D6A4F] rounded-2xl text-lg font-bold transition-all shadow-[0_8px_40px_rgba(64,145,108,0.5)] hover:-translate-y-1 text-center">Começar grátis agora →</Link>
            <a href={WA} target="_blank" rel="noopener noreferrer" id="cta-wa-psicologia" className="px-10 py-5 bg-white/5 hover:bg-white/10 border border-white/15 rounded-2xl text-lg font-semibold transition-all flex items-center justify-center gap-2">
              <svg className="w-5 h-5 text-[#52B788]" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
              Falar no WhatsApp
            </a>
          </div>
