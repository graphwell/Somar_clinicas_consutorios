...
/**
 * POST /api/n8n/fila-espera/confirmar
 * Ferramenta: tool_fila_confirmar
...
export async function POST(req: NextRequest) {
  ...
  try {
    const resp = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/api/fila-espera/confirmar`, {
      method: 'POST',
    ...
    console.error('[n8n/fila-espera/confirmar]', err);
